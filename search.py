...
SEARCH_ENGINES =[
    ...
    {"name": "Candle", "url": "http://gjobqjj7wfcw6jrx.onion/search?q={query}"},
    {"name": "Recon", "url": "http://recon222tttn4ob7ujdh4g6m3i3e5m2f3q5k5k.onion/search?q={query}"},
    {"name": "Kilos", "url": "http://kilosv7k2mxs7m7k.onion/search?q={query}"},
    {"name": "Haystak", "url": "http://haystak5njsmn2hqkew3p6q7x2o5z5j4z5z5z5z5z5z5z5z5.onion/search?q={query}"},
    {"name": "Grams", "url": "http://grams7enuf7h5h7v.onion/search?q={query}"},
    {"name": "Evil", "url": "http://evils2k5c6u3z4o4.onion/search?q={query}"},
    {"name": "DarkSearch", "url": "http://darksearch.io.onion/search?q={query}"},
    {"name": "OnionSearchEngine", "url": "http://onionsearchengine.com.onion/search?q={query}"},
    {"name": "FreshOnions", "url": "http://freshonions.onion/search?q={query}"},
    {"name": "TorSearch", "url": "http://torsearch.com.onion/search?q={query}"},
